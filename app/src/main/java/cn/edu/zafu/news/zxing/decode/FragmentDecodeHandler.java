...
final class FragmentDecodeHandler extends Handler {

	private static final String TAG = FragmentDecodeHandler.class.getSimpleName();

	private final CaptureFragment fragment;
	private final MultiFormatReader multiFormatReader;
	private boolean running = true;

	FragmentDecodeHandler(CaptureFragment fragment, Map<DecodeHintType, Object> hints) {
