...
import cn.edu.zafu.news.zxing.decode.DecodeThread;
import cn.edu.zafu.news.zxing.decode.FragmentDecodeThread;
import cn.edu.zafu.news.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureFragmentHandler extends Handler {
  ...
  private final FragmentDecodeThread decodeThread;
  private State state;
  ...
  CaptureFragmentHandler(CaptureFragment fragment,
    ...
    decodeThread = new FragmentDecodeThread(fragment, decodeFormats, baseHints, characterSet,
  ...
  public void handleMessage(Message message) {
    if (message.what == R.id.restart_preview) {
      ...
      fragment.setFragmentResult(Activity.RESULT_OK, (Intent) message.obj);
      fragment.popToBack();
